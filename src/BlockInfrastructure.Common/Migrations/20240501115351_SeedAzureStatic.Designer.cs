...
namespace BlockInfrastructure.Common.Migrations
{
    ...
    [Migration("20240501115351_SeedAzureStatic")]
    partial class SeedAzureStatic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlockInfrastructure.Common.Models.Data.Plugin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            PluginTypeDefinitions = "[{\"FieldName\":\"ClientId\",\"FieldType\":\"string\",\"FieldDescription\":\"Azure Client ID\",\"IsRequired\":true,\"IsSecret\":false,\"DefaultValue\":\"\"},{\"FieldName\":\"ClientSecret\",\"FieldType\":\"string\",\"FieldDescription\":\"Azure Client Secret\",\"IsRequired\":true,\"IsSecret\":true,\"DefaultValue\":\"\"},{\"FieldName\":\"SubscriptionId\",\"FieldType\":\"string\",\"FieldDescription\":\"Azure Subscription ID\",\"IsRequired\":true,\"IsSecret\":false,\"DefaultValue\":\"\"},{\"FieldName\":\"TenantId\",\"FieldType\":\"string\",\"FieldDescription\":\"Azure Tenant ID\",\"IsRequired\":true,\"IsSecret\":false,\"DefaultValue\":\"\"}]",
                            SamplePluginConfiguration = System.Text.Json.JsonDocument.Parse("{\"SubscriptionId\":\"Subscription ID\",\"ClientId\":\"Client ID\",\"ClientSecret\":\"Client Secret\",\"TenantId\":\"Tenant ID\"}", new System.Text.Json.JsonDocumentOptions()),
                            UpdatedAt = new DateTimeOffset(new DateTime(2024, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });

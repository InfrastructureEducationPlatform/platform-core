...
namespace BlockInfrastructure.Common.Migrations
{
    ...
    [Migration("20240225144130_AddTypeDefToPlugin")]
    partial class AddTypeDefToPlugin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlockInfrastructure.Common.Models.Data.Plugin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PluginTypeDefinitions = "[{\"FieldName\":\"AccessKey\",\"FieldType\":\"string\",\"FieldDescription\":\"AWS Access Key\",\"IsRequired\":true,\"DefaultValue\":\"\"},{\"FieldName\":\"SecretKey\",\"FieldType\":\"string\",\"FieldDescription\":\"AWS Secret Key\",\"IsRequired\":true,\"DefaultValue\":\"\"},{\"FieldName\":\"Region\",\"FieldType\":\"string\",\"FieldDescription\":\"AWS Region\",\"IsRequired\":true,\"DefaultValue\":\"ap-northeast-2\"}]",
